...
//파싱:구분분석,문자을 이루고 있는 구성 성분을 분해하고 분해된 성분의 관계를 분석하여 구조를 결정하는 것
...
//    사용자가 태그를 만드렁서 사용하는 언어
//태그: <시작태그 속성 ="값" 속성="값"> 텍스트 </끝태그>

//XML파싱:xml 구성된 데이터를 원하는 데이터만 추출, 가공하는 것
...
public static void main(String[] args) {
	...
	String pathname="D:"+File.separator+"KJH"+File.separator+"오늘 날씨.txt";
