...
public class Ex02_File {
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("파일경로:"+file.getName());
			System.out.println("=========");
			File file2 =new File("D:/KJH/EXAM/AAA");
			...
			System.out.println("=============");
			//디렉토리 삭제
			File file4 =new File("D:/KJH/EXAM/AAA");
			boolean res4=file4.delete();
			if(res4) {
				System.out.println("파일삭제성공");
				File file5 =new File("D:/KJH/EXAM");
				boolean res5=file4.delete();
				if(res5) {
