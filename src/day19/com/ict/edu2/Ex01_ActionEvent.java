...
//이벤트:사용자가 어떠한 행동,동작을 하는 것을 말한다.
	...
	//ActionEvent:컴포넌트를 눌렀거나, 선택되어있을때,Enter키를 눌렀을 때 발생하는 이벤트
...
public class Ex01_ActionEvent extends JFrame implements ActionListener{
	...
	JButton jb1=new JButton("입력1");
	JButton jb2=new JButton("입력2");
	...
	setBounds(ds.width/2-150,ds.height/2-50,200,100);
	...
	//ActionListener일 때 이벤트 처리를 받아서 실제 처리해주는 매서드
	@Override
	public void actionPerformed(ActionEvent e) {
		//System.out.println("버튼을 눌렀네요");
		 JButton obj=(JButton) e.getSource();
		if(obj==jb1) {
			System.out.println("입력1가 눌렸네");
		}else if(obj==jb2) {
