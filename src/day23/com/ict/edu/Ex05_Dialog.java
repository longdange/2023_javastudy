...
//			//JOptionPane.showConfirmDialog(parentComponent, message);
			...
			//JOptionPane.showConfirmDialog(parentComponet, message,title,optionType);
	...
	jb3.addActionListener(new ActionListener() {
		...
		@Override
		public void actionPerformed(ActionEvent e) {
			//입력 다이얼 로그:사용자에게 정보를 받는 다이얼 로그(js(자바스크립트에서는 prompt()==거의 사용 안함)
			//String msg= JOptionPane.showConfirmDialog(parentComponent, message)
			//String msg= JOptionPane.showInputDialog(jp, "나이: ");
			//System.out.println(msg);
			//String msg= JOptionPane.showConfirmDialog(parentComponent, message,초기값);
...
//			JOptionPane.showOptionDialog(paparentComponent, message, title, optionType,messageType, null,null
//					, null);
			//int res=JOptionPane.showOptionDialog(jp, "방가방가","사용자 다이얼 로그",
