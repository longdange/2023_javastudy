...
switch (menu) {
case 1:DAO.getinstace().getSelectAll(); break;
case 2:
	System.out.println("고객 아이디:"); 
	String c_id=scan.next();
	DAO.getinstace().getSelectOne(c_id);break;
case 3:
	...
	DAO.getinstace().getInsert(c_id2,c_name,c_age,c_rank,c_job,c_point);
	break;
case 4:System.out.println("삭제할 고객아이디:");
	String c_id3 =scan.next();
	DAO.getinstace().getDelete(c_id3);break;
case 5:
