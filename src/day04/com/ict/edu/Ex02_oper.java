...
public class Ex02_oper {
	public static void main(String[] args) {
		//중첩 삼형 연산자:삼형 연산자가 중첩되는 것
		//형식) 자료형 변수이름 =(조건식1)?((조건식2)?조건식2가 참일때:조건식2이 거짓일 때):조건식1이 거짓일 때
		//형식) 자료형 변수이름 =(조건식1)?조건식1이 참일때:((조건식2)?조건식2가 참일때:조건식2이 거짓일 때)
	...
	//int k3이 1 또는 3이면 남자 2또는 4이면 여자
	    //    1 또는 2이면 1900년대 태어남,3또는 4는 2000년대에 태어남,나머지는 외국인 
	    int k3=1;
