...
public class Ex01_array {
	public static void main(String[] args) {
		...
		//          그러나 특정 몇 개나 특정 하나를 별도로 출력하거나 가공 할 수 없다(단정)
		//          인덱스값을 이용할 수 없다.
		
		//:=>오른쪽 배열을 하나씩 순서대로 왼쪽에 남긴다.
		...
		int[]su2=new int[4];//선언과 생성을 한 번에 
		int[]su1= {67,9,15,4};//선언과 생성과 저장을 한 번에 
	}
}
